...
const Public = () => {
    ...
    return (
        <div className="min-vh-100 d-flex flex-column" style={{ backgroundColor: colors.bodyBg || '#f8f9fa' }}>
            ...
            >
                <div className="container">
                    ...
                    <button 
                        ...
                        style={{ zIndex: 1100, width: '40px', height: '40px', border: 2, backgroundColor:colors.orange, borderRadius: '6px', borderColor: colors.White || '#ffffff', justifyContent: 'center', alignItems: 'center', display: 'flex' }} 
                    >
            ...
            {/* STRUCTURE ET COMPOSANTS APRES HERO */}
            <div className="container mt-5">
    ...
    return (
        <section className="py-5 px-4 mb-5 text-center rounded-4 text-white" style={{ backgroundColor: colors.darkGreen }}>
            ...
            <p className="text-white mb-4 col-lg-6 mx-auto text-adaptive">
                Accédez à votre tableau de bord et commencez à suivre vos opérations dès aujourd'hui.
            </p>
