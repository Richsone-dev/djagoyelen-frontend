                            ...
                            <ul className="nav flex-column">
                                {section.links.map((link) => (
                                    <li className="nav-item mb-1" key={link.path}>
                                        {link.disabled ? (
                                            <span className="nav-link text-white d-flex align-items-center p-2" style={{ borderRadius: '10px', transition: '0.3s', cursor: 'not-allowed', backgroundColor: 'rgba(#198754, 0.1)' }}>
