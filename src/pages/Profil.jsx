...
const Profil = () => {
    ...
    // Initialisation avec le champ phone
    ...
    const loadData = async () => {
        ...
        try {
            ...
            // Mise à jour des données incluant le téléphone
            setFormData({ 
    ...
    const handleUpdateProfile = async (e) => {
        ...
        try {
            ...
            showFeedback('danger', "Erreur lors de la mise à jour du profil.");
        }
    };
    ...
    const handleUpdatePassword = async (e) => {
        ...
        try {
            ...
            showFeedback('danger', error.response?.data?.message || "Erreur lors de la mise à jour.");
        }
    };
